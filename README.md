<p align="left">
<img src="./logo2.png" width="300" height="53"/><br>
...
Please cite the SEA paper if you use the sequential version, and cite the bioRxiv paper if you use the parallel version or range queries.
