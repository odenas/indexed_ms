...
static inline uint64_t read_bit64(uint64_t bit_idx,uint64_t * bitvec)
{
...
static inline uint64_t ms_at_idx64(uint64_t bit_idx,uint64_t bitvec_size,uint64_t * bitvec)
{
