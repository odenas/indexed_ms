...
namespace fdms {
    ...
    private:
        ...
        static size_type find_k_prim_(size_type __k, const size_type max__k, sdsl::int_vector_buffer<1>& __runs) {
        ...
        string runs_fname{"runs.bin"};

    public:
        sdsl::int_vector_buffer<1> runs;
        bitvec_type ms;
