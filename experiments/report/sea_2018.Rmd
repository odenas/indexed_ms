...
cbbPalette <- c("#0072B2", "#D55E00", "#CC79A7", "#000000")
...
p1 <- ggplot(df1, aes(nthreads, log2(time_ratio), color = inp_type)) +
  ...
  scale_y_continuous(name = "Time ratio (log2)") +
...
p2 <- ggplot(df2 %>% mutate(tit = 'Correction runs'),
...
multiplot(p1, q1, p2, q2, p3, q3, p4, q4,
