...
operations = data.frame(id=c("LCA", "LETTER", "SLINK", "CHILD", "DEPTH", "PARENT", "WLINK"),
						caption=c("LCA", "Letter", "SLink", "Child", "SDepth", "Parent", "WLink"),
						filename=c("lca", "letter", "slink", "child", "depth", "parent", "wlink"))
