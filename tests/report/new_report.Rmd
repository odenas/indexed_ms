...
big_dt <- (read_csv('../wl_tests/sandbox_maxrep/rep_100000000s_sim_500000t_abcd.s.csv') %>%
             mutate(dset="big"))
small_dt <- (read_csv('../wl_tests/sandbox_maxrep/rep_1000000s_sim_200000t_abcd.s.csv') %>% 
               mutate(dset="small"))
...
ggplot(all_dt, aes(tp, tcall, fill=method)) + geom_boxplot(position='dodge') + facet_wrap(~dset, ncol = 1, scales = "free_y")
