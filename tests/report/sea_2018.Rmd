...
prange_plot <- function(dt){
  ggplot(dt, aes(setup, value, color=sequence)) +
    ...
    ylab("Competitor / This paper") + scale_color_manual(values=c("#d95f02", "#000000")) + scale_x_discrete(labels = function(x) str_wrap(x, width = 10))
}
...
prange_plot(dt) + facet_wrap(~measuring, scales="free_y")
```
